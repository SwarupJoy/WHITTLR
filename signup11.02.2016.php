    ...
    <div class="login_area">
		...
		<form action="" name="registerSignup" id="registerSignup" method="post">
			...
			<input  class="name_fld" type="text" name="fname" id="fname" maxlength="25">
			<label>Last Name</label>
			<input  class="name_fld" type="text" name="lname" id="lname" maxlength="25">
			    <label>Email</label>
			<input class="name_fld" type="email" name="email" id="email" maxlength="50">
			<label>Password</label>
			<input class="name_fld" type="password" name="password" id="password" maxlength="20">
			<div class="checkbox">
